        ...
        success: function (msg) {
            ...
            if (msg.success) {
                if (callbackfunction == null || callbackfunction == undefined) {
                    ...
                    alertPromptMsgDlg(msg.message, 1, callbackfunction);
                }
            } else {
...
function ajax(type, data, url, onSuccess, onFail) {
    $.ajax({
        url: url,
        type: type,
        async: false,
...
function loadScript(module, jsFile) {
    var jsUrl = jsURL(module, jsFile);
    jQuery.ajax({
        url: jsUrl,
        type: "GET",
        dataType: "script",
...
function jsURL(module, jfFile) {
    return $('#projectURL').val() + "/js/" + module + "/" + jfFile;

        ...
        <div id="divContent" class="col-sm-12 div-content-main">
            <div class="div-title-bar clearfix">
                <div id="divCreateBtn" class="div-toolbar-button">
                    <button id="btnCreateOperation" class="btn btn-default" data-toggle="modal" data-target="#modalPopup" onclick="forwardToCreateOperation()">
                        创建操作
                    </button>
                </div>
            </div>
            ...
            <div class="div-list-table div-list-table-layout">
                ...
                <table class="table fixed-table table-hover table-condensed">
                    ...
                    <tbody>
                    <c:forEach items="${operationList}" var="item" varStatus="rownum">
                        ...
                        <tr class="
                            ...
                            <td>
                                <div class="row td-div-operation">
                                    <label id="editOperation_${item._id}" class="table-icon-label">
                                        <i class="icon-edit icon-large"></i>
                                    </label>
                                    <label id="deleteOperation_${item._id}" class="table-icon-label">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/operation/operation_common.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/operation/operation_create.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/operation/operation_edit.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/operation/operation_delete.js"></script>
<div id="script"></div>
<script>
    $(function () {
    });

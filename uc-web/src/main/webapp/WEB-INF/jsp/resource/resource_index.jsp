                    ...
                    <div class="col-md-3">
                        <div class="thumbnail" style="margin-left: 10px;margin-top: 10px">
                            ...
                            <div class="caption" style="overflow:auto;height:700px;">
                                <ul id="resourceTreeForInit" class="ztree"></ul>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/resource/resource_common.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/resource/resource_index.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/resource/resource_create.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/resource/resource_edit.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/resource/resource_delete.js"></script>
<div id="script"></div>
<script>

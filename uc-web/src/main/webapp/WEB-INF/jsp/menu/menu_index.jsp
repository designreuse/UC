            ...
            <div class="panel panel-default">
                ...
                <div class="clearfix div-list-toolbar">
                    ...
                    <div id="divCreateBtn" class="div-toolbar-button">
                        <button id="btnCreateOrg" class="btn btn-default" data-toggle="modal" data-target="#modalPopup" onclick="forwardToCreateMenu()">
                            <i class="icon-plus"></i>
                            添加菜单
                        </button>
                        <button id="btnDeleteOrg" class="btn btn-default"  onclick="confirmDeleteMenu()">
                            <i class="icon-plus"></i>
                            删除菜单
                        </button>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="thumbnail" style="margin-left: 10px;margin-top: 10px">
                            ...
                            <div class="caption" style="overflow:auto;height:700px;">
                                <ul id="menuTreeForInit" class="ztree"></ul>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/menu/menu_common.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/menu/menu_index.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/menu/menu_edit.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/menu/menu_create.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/menu/menu_delete.js"></script>

            ...
            <div class="panel panel-default">
                ...
                <div class="clearfix div-list-toolbar">
                    ...
                    <div id="divCreateBtn" class="div-toolbar-button">
                        <button id="btnCreateOrg" class="btn btn-default" data-toggle="modal" data-target="#modalPopup" onclick="forwardToCreateModule()">
                            <i class="icon-plus"></i>
                            添加模块
                        </button>
                        <button id="btnDeleteOrg" class="btn btn-default" onclick="confirmDeleteModule()">
                            <i class="icon-plus"></i>
                            删除模块
                        </button>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="thumbnail" style="margin-left: 10px;margin-top: 10px">
                            <div style="width:86%;margin-left:7%;margin-top:15px" id="divSearch">
                                <input class="form-control" id="search_module" class="popover-content" maxlength="256"
                                       title="请输入模块名称搜索"
                            ...
                            <div class="caption" style="overflow:auto;height:700px;">
                                <ul id="moduleTreeForInit" class="ztree"></ul>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="popUserOrOrgMove" role="dialog" aria-hidden="true">
...
<div class="modal fade" id="popUserOrOrgDelete" role="dialog" aria-hidden="true">
    <div class="modal-dialog" style="width:300px; height:500px;">
        <div class="modal-content">
        </div>
    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/module/module_common.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/module/module_index.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/module/module_create.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/module/module_edit.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/module/module_delete.js"></script>

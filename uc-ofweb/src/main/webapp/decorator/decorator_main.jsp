    ...
    <div id="content">
        <div id="content_left">
            <ul class="nav navbar-nav">
                <li><a class="no-underline" href="/org/index">
                ...
                <li id="sessionFirstNav">
                    <a class="no-underline" href="${pageContext.request.contextPath}/session/list">
                        <img class="sidebar-img" src="${pageContext.request.contextPath}/images/menu/session.png"/>
                        <br><span>会话管理</span>
                    </a>
                </li>
                <li id="systemManageFirstNav">
                    <a class="no-underline" href="${pageContext.request.contextPath}/warning/warningSetting">

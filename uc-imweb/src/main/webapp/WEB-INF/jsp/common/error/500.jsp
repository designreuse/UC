<%--
	500错误显示页面。系统出现500错误时由该页面进行比较友好的提示
	500错误一般是jsp页面的错误，异常框架捕获不到，因此需要另外在web.xml配置500错误对应的提示页面
	author:yjz
	since:2014-9-30
--%>
	...
	<body>
		<table height="100%" bgcolor="" cellpadding="0" cellspacing="0" align="center" border="0" bordercolor="#000000">
			<tr>	
				...
				<td valign="middle">
					<font size=5>
						<spring:message code="system.common.error.page.500" text="system.common.error.page.500"/>
					</font>
				</td>
			</tr>
		</table>

...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#confirm").click(function(){
            ...
            relStaffId = relStaffId.replace(/_staff/g,"");//默认加了后缀
    ...
    function loadTree() {
        ...
        $.ajax({
            ...
            type: "GET",
            dataType: "json",
            url: contextPath+"/staff/showOrgStaffTreeNodes", //请求的action路径
            ...
            success: function(result) { //请求成功后处理函数。此处的data是JSON对象
                if(result.success){
                    ...
                    jQuery.each(data, function(i, item) {
                        treeNodes.push(new NodeWithUser(item.id+"_"+item.type, item.pid+"_"+item.parentType, item.name, item.isParent, item.type, item.gender, item.pinyin, item.pinyinAlia, item.mail));
                    });

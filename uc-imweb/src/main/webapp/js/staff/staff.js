/*var zNodes =[
    ...
    { id:121, pid:22, name:"随意勾选 1-2-1",age:23},
...
function Staff(type,id,name,pid){
    ...
    this.getUrl = function(){
        if(type == selectType[0]){
            return "/imweb/staff/showOrgStaffTreeNodes";
        }else{
            return "/imweb/staff/showRoomStaffTreeNodes";
        }
    }
...
Staff.prototype = {
    ...
    addNode:function(treeNode){
        ...
        if(!_self.isSelected(treeNode)){
            var li="<li id='"+treeNode[_self.id]+"'>"+treeNode[_self.name]+"</li>";
...
//选择类型：["组织架构"，"群组"]
var selectType = ["org",'room'];
//组织架构
var orgStaff = new Staff(selectType[0],"id","name","pid");
//群组
var roomStaff = new Staff(selectType[1],"id","name","pid");
